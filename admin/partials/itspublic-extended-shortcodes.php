    ...
    <div class="searchbox__cover">
        <form action="http://itspublic.local/materialen/?ms=a" class="searchbox__cover-form" method="get">
            <div class="searchbox__cover-form--input">
                <input type="text" value="" class="search-input" id="search_field" placeholder="Zoek hier naar publicaties, trainingen en methodieken. Bijvoorbeeld 'onderwijs' of 'storytelling'" />
